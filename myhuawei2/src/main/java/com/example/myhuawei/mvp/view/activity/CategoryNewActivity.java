...
import com.example.myhuawei.adapter.top.CategoryNewTopWrapper;
...
import com.example.myhuawei.mvp.presenter.impl.CategoryNewPresenterImpl;
...
//        title_bar.setBackgroundResource(R.color.black_alpha_5);
    ...
    @Override
    protected CategoryNewPresenterImpl intiinject() {
